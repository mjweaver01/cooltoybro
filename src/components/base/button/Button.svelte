<script lang="ts">
  ...
  const buttonVariants: any = {
    amazon:
      'flex justify-center items-center disabled:opacity-30 disabled:pointer-events-none py-2 px-4 rounded-md text-white bg-orange-600 sm:hover:bg-orange-500/80 focus:outline-none focus:ring-2 transition duration-200 ease-in-out',
    flipper:
      'flex justify-center items-center disabled:opacity-30 disabled:pointer-events-none py-2 px-4 rounded-md text-white bg-orange-600 sm:hover:bg-orange-500/80 focus:outline-none focus:ring-2 transition duration-200 ease-in-out',
    raspberry_pi:
      'flex justify-center items-center disabled:opacity-30 disabled:pointer-events-none py-2 px-4 rounded-md text-white bg-rose-600 sm:hover:bg-orange-500/80 focus:outline-none focus:ring-2 transition duration-200 ease-in-out',
    google:
      'disabled:opacity-50 disabled:pointer-events-none group relative w-full flex justify-center items-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md bg-white sm:hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',
    outlined:
      'py-2 px-4 rounded-md border border-gray-300 text-black bg-white sm:hover:bg-gray-50 transition duration-200 ease-in-out',
    ghost:
      'relative flex w-full items-center justify-start space-x-2 rounded-md p-2 text-left text-sm transition-all duration-75 sm:hover:bg-gray-100',
    rounded:
      'rounded-full border border-black bg-black p-1.5 px-4 text-sm text-white sm:hover:bg-black/80 transition duration-200 ease-in-out ',
    secondary:
